<template>
  <div class="card">
    <div class="card-top border-bottom text-center">
      <a href="#"> Back to Home</a> <span id="logo">YMP Book.lk</span>
    </div>
    <div class="card-body">
      <div class="row upper">
        <span><i class="fa fa-check-circle-o"></i>Payment Details</span>
        <span><i class="fa fa-check-circle-o"></i></span>
        <span id="payment">My Booking Details</span>
      </div>
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="right border">
            ...
            <div class="row item">
              <div class="col-4 align-self-center">
                <img
                  class="img-fluid"
                  src="https://m.media-amazon.com/images/I/A1hFzTczzJL._AC_SY679_.jpg"
                />
              </div>
              <div class="col-8">
                <div class="row"><b>Rs. 600.00</b></div>
                <div class="row text-muted">JUMANJI welcome to the jungle</div>
                <div class="row">ticket quantity:2</div>
              </div>
            </div>
